  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-neutral-400 focus-visible:ring-neutral-400/50 focus-visible:ring-[1.5px] dark:focus-visible:border-neutral-600 dark:focus-visible:ring-neutral-600/50",
        className
      )}
      {...props}
    />
